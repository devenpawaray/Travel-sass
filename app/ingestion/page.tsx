    ...
    <div className="min-h-screen bg-white text-slate-700 font-mono text-sm p-8">
      <div className="max-w-4xl mx-auto">
        <header className="mb-12">
          <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tighter">Data Ingestion Terminal</h1>
        ...
        <div className="grid gap-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            <button className="p-8 border border-slate-200 rounded-xl bg-white hover:border-indigo-500/50 transition group">
              ...
              <span className="text-slate-900 font-bold uppercase tracking-tight">Partner Feed</span>
            </button>
            <button className="p-8 border border-indigo-500/30 rounded-xl bg-indigo-50 hover:border-indigo-500 transition group ring-1 ring-indigo-500/10">
              <span className="block text-[10px] text-indigo-400 mb-2 uppercase font-bold tracking-widest">Active Input</span>
              <span className="text-slate-900 font-bold uppercase tracking-tight">Manual Payload</span>
            </button>
            <button className="p-8 border border-slate-200 rounded-xl bg-white hover:border-indigo-500/50 transition group">
              ...
              <span className="text-slate-900 font-bold uppercase tracking-tight">Document OCR</span>
            </button>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-2xl">
            ...
            <div className="p-0">
              <textarea 
                ...
                className="w-full h-64 bg-transparent p-6 font-mono text-indigo-700 outline-none resize-none placeholder:text-slate-300"
                spellCheck="false"
              />
            </div>
            <div className="p-6 border-t border-slate-200 bg-slate-50">
              <button 
                ...
                disabled={loading}
                className="w-full py-4 bg-slate-900 text-white font-black uppercase text-xs tracking-[0.2em] hover:bg-slate-800 transition disabled:opacity-50"
              >
